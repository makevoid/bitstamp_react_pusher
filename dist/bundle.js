...
(function(Opal) {
  ...
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass, $hash2 = Opal.hash2, content = nil;

  Opal.add_stubs(['$new', '$on', '$puts', '$==', '$select', '$>', '$map', '$to_f', '$empty?', '$bids=', '$sort_by', '$-@', '$+', '$bids', '$asks=', '$asks', '$include', '$round', '$[]', '$params', '$div', '$after_mount', '$define_state', '$timer=', '$h3', '$p', '$section', '$present', '$each_with_index', '$render', '$create_element']);
  ...
  (function($base, $super) {
    ...
    return (def.$render = function() {
      ...
      ($a = ($b = self).$div, $a.$$p = (TMP_15 = function(){var self = TMP_15.$$s || this, $a, $b, TMP_16, $c, TMP_17;
        ...
        return ($a = ($c = self).$div, $a.$$p = (TMP_18 = function(){var self = TMP_18.$$s || this, $a, $b, TMP_19, $c, TMP_22;

        ($a = ($b = self).$section, $a.$$p = (TMP_19 = function(){var self = TMP_19.$$s || this, $a, $b, TMP_20, $c, TMP_21;

          ($a = ($b = self).$h3, $a.$$p = (TMP_20 = function(){var self = TMP_20.$$s || this;

            return "Bids"}, TMP_20.$$s = self, TMP_20), $a).call($b);
            return ($a = ($c = self.$bids().$each_with_index()).$map, $a.$$p = (TMP_21 = function(trade, idx){var self = TMP_21.$$s || this, $a, price = nil, volume = nil, comp = nil;
if (trade == null) trade = nil;if (idx == null) idx = nil;
            $a = Opal.to_ary(trade), price = ($a[0] == null ? nil : $a[0]), volume = ($a[1] == null ? nil : $a[1]);
              ...
              return comp;}, TMP_21.$$s = self, TMP_21), $a).call($c);}, TMP_19.$$s = self, TMP_19), $a).call($b, $hash2(["className"], {"className": "bids three columns"}));
          return ($a = ($c = self).$section, $a.$$p = (TMP_22 = function(){var self = TMP_22.$$s || this, $a, $b, TMP_23, $c, TMP_24;

          ($a = ($b = self).$h3, $a.$$p = (TMP_23 = function(){var self = TMP_23.$$s || this;

            return "Asks"}, TMP_23.$$s = self, TMP_23), $a).call($b);
            return ($a = ($c = self.$asks().$each_with_index()).$map, $a.$$p = (TMP_24 = function(trade, idx){var self = TMP_24.$$s || this, $a, price = nil, volume = nil, comp = nil;
if (trade == null) trade = nil;if (idx == null) idx = nil;
            $a = Opal.to_ary(trade), price = ($a[0] == null ? nil : $a[0]), volume = ($a[1] == null ? nil : $a[1]);
              comp = self.$present($scope.get('Transaction'), $hash2(["price", "volume", "key"], {"price": price, "volume": volume, "key": "ask-" + (idx)}));
              return comp;}, TMP_24.$$s = self, TMP_24), $a).call($c);}, TMP_22.$$s = self, TMP_22), $a).call($c, $hash2(["className"], {"className": "asks three columns"}));}, TMP_18.$$s = self, TMP_18), $a).call($c, $hash2(["className"], {"className": "tx_list row"}));}, TMP_14.$$s = self, TMP_14), $a).call($b);
    }, nil) && 'render';
  })(self, null);
